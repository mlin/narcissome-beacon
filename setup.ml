...
(* OASIS_START *)
(* DO NOT EDIT (digest: dda31c5cb9250b3677e3ede4a2533337) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$beacon_tests", []))];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("yajl-extra", None);
                           FindlibPackage ("snappy", None)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "beacon_server.ml"});
               Executable
                 ({
                     cs_name = "beacon_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "beacon_tests.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "beacon_tests"]
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\224\237\020/\141x\128\229hy\022\156R\001sI";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
